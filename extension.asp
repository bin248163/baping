...
<div class="w-100" style="background: url(images/tg_02.jpg) no-repeat center;height: 640px;"></div>

<div class="w-1000 pt-80">
	<div class="a_center">
		<h2 style="padding:0 0 10px 0;font-size: 35px;line-height: 40px;">感受网络营销的力量</h2>
	</div>
	<div class="w-1000 pt-40 pb-70">
		<img src="images/yx_05.jpg" alt="" style="float: left;" />
		<div class="sh">
			<div>
				<h2>双十一成交总额<span>1770.4亿</span></h2>
				<p>看看你的支付宝账单<br />你就知道你每天败家多少钱~</p>
			</div>
			<div>
				<h2>百度搜索引擎市场<span>587亿</span></h2>
				<p>百度每日处理的搜索量超过50亿<br />你平均每天至少百度4次~</p>
			</div>
			<div>
				<h2>韩束面膜微商<span>3个月</span>销售过亿</h2>
				<p>55.2%的用户每天打开微信10次以上<br />你就知道自己是有多严重的依赖症~</p>
			</div>
		</div>
	</div>
</div>
<div class="w-100b">
	<div class="w-1000">
		<div class="a_center">
			<h2 style="padding:60px 0 10px 0;font-size: 35px;line-height: 40px;border-bottom: 5px solid #392c24;">账户推广服务内容</h2>
		</div>
	</div>
	<div class="w-1000 fw">
