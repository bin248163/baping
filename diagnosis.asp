...
<div class="w-100" style="background: url(images/zd_02.jpg) no-repeat center;height: 640px;"></div>

<div class="w-1000 pt-80 pb-70">
	<img src="images/zd1_05.jpg" alt="" />
</div>
<div class="w-100b">
	<div class="w-1000">
		<div class="a_center">
			<h2 style="padding:60px 0 10px 0;font-size: 35px;line-height: 40px;">我们为您提供哪些诊断服务？</h2>
